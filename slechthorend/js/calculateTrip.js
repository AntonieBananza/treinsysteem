    ...
    fetch("../fetch/fetch-route.php",
        ...
        fetch("../fetch/fetch-transport.php",
            ...
            for (let i = 0; i < transportData.length; i++) {
                ...
                let stationName = transportData[i].station;
            ...
            while (i < stations.length && !endReached) {
                ...
                if (beginReached) {
                    ...
                    stationLink.href = `stationmap.php?stationName=${stations[i].name}`;
                    ...
                    stationLink.appendChild(stationDiv);
                    stationSection.appendChild(stationLink);
